...
declare namespace FudgeCore {
  ...
  abstract class Serializer {
     ...
     * @param _object An object to serialize, implementing the {@link Serializable} interface
     */
    static serializeArray<T extends Serializable>(
      _type: new () => T,
      _objects: Serializable[]
    ): Serialization;
    /**
...
declare namespace FudgeCore {
  class RenderInjector {
    static inject(
      ...
      _injector: typeof RenderInjector
    ): void;
  }
}
declare namespace FudgeCore {
...
declare namespace FudgeCore {
  class RenderInjectorCoat extends RenderInjector {
    static decorate(_constructor: Function): void;
    protected static injectCoatColored(
      this: Coat,
      _shader: typeof Shader,
      _cmpMaterial: ComponentMaterial
    ): void;
    protected static injectCoatTextured(
      this: Coat,
      _shader: typeof Shader,
      _cmpMaterial: ComponentMaterial
    ): void;
    protected static injectCoatMatCap(
      this: Coat,
      _shader: typeof Shader,
      _cmpMaterial: ComponentMaterial
    ): void;
...
declare namespace FudgeCore {
  ...
  class RenderInjectorMesh {
    ...
    protected static useRenderBuffers(
      this: Mesh,
      _shader: typeof Shader,
      _mtxWorld: Matrix4x4,
      _mtxProjection: Matrix4x4,
      _id?: number
    ): void;
...
declare namespace FudgeCore {
  ...
  abstract class RenderWebGL extends EventTargetStatic {
     ...
     */
    static setAttributeStructure(
      _attributeLocation: number,
      _bufferSpecification: BufferSpecification
    ): void;
    /**
    ...
    protected static pick(
      _node: Node,
      _mtxMeshToWorld: Matrix4x4,
      _mtxWorldToView: Matrix4x4
    ): void;
    /**
     ...
     */
    protected static drawMesh(
      _cmpMesh: ComponentMesh,
      cmpMaterial: ComponentMaterial,
      _mtxMeshToWorld: Matrix4x4,
      _mtxWorldToView: Matrix4x4
    ): void;
  }
...
declare namespace FudgeCore {
  ...
  class Vector3 extends Mutable {
     ...
     */
    map(
      _function: (value: number, index: number, array: Float32Array) => number
    ): Vector3;
    serialize(): Serialization;
...
declare namespace FudgeCore {
  ...
  abstract class Mesh extends Mutable implements SerializableResource {
     ...
     */
    protected static getTrigonsFromQuad(
      _quad: number[],
      _even?: boolean
    ): number[];
    protected static deleteInvalidIndices(
      _indices: number[],
      _vertices: Vector3[]
    ): void;
    get type(): string;
...
declare namespace FudgeCore {
  ...
  class MeshTerrain extends Mesh {
    ...
    constructor(
      ...
      _resolution?: Vector2,
      _scaleInput?: Vector2,
      _functionOrSeed?: HeightMapFunction | number
    );
    create(
      _resolution?: Vector2,
      _scaleInput?: Vector2,
...
declare namespace FudgeCore {
  ...
  class MeshTorus extends Mesh {
    ...
    constructor(
      _name?: string,
      _thickness?: number,
      _majorSegments?: number,
      _minorSegments?: number
    );
    create(
      _thickness?: number,
      _majorSegments?: number,
...
declare namespace FudgeCore {
  ...
  abstract class ComponentJoint extends Component {
    ...
    constructor(
      _attachedRigidbody?: ComponentRigidbody,
      _connectedRigidbody?: ComponentRigidbody
    );
...
declare namespace FudgeCore {
  ...
  class ComponentRigidbody extends Component {
    ...
    constructor(
      _mass?: number,
      _type?: BODY_TYPE,
      _colliderType?: COLLIDER_TYPE,
      _group?: COLLISION_GROUP,
      _mtxTransform?: Matrix4x4,
      _convexMesh?: Float32Array
    );
    get id(): number;
...
declare namespace FudgeCore {
  ...
  class PhysicsDebugShader {
    ...
    getAttribIndices(
      _attribs: Array<PhysicsDebugVertexAttribute>
    ): Array<number>;
...
declare namespace FudgeCore {
  ...
  class EventPhysics extends Event {
    ...
    constructor(
      _type: EVENT_PHYSICS,
      _hitRigidbody: ComponentRigidbody,
      _normalImpulse: number,
      _tangentImpulse: number,
      _binormalImpulse: number,
      _collisionPoint?: Vector3,
      _collisionNormal?: Vector3
    );
  }
  /**
...
declare namespace FudgeCore {
  ...
  abstract class Render extends RenderWebGL {
    ...
    static prepare(
      _branch: Node,
      _options?: RenderPrepareOptions,
      _mtxWorld?: Matrix4x4,
      _lights?: MapLightTypeToLightList,
      _shadersUsed?: typeof Shader[]
    ): void;
    /**
...
declare namespace FudgeCore {
  ...
  class FileIoBrowserLocal extends EventTargetStatic {
    ...
    static save(
      _toSave: MapFilenameToContent,
      _type?: string
    ): Promise<MapFilenameToContent>;
...
declare namespace FudgeCore {
  ...
  abstract class Project {
     ...
     */
    static register(
      _resource: SerializableResource,
      _idResource?: string
    ): void;
     ...
     */
    static deserialize(
      _serialization: SerializationOfResources
    ): Promise<Resources>;
...
declare namespace FudgeCore {
  ...
  export class TextureCanvas extends Texture {
    ...
    constructor(
      _name: string,
      _crc2: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D
    );
    get texImageSource(): TexImageSource;
  }
  /**
